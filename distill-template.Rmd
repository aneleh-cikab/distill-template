...
Before training our select models, we conducted an experiment checking the performace of the baseline model with different ratio of positive and negative events (accidents vs. non-accidents). 
